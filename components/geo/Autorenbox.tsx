  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von energietechnik-stellenangebote.de. Mit jahrelanger Erfahrung im
        Bereich Energietechnik und Personalwesen hat er dieses spezialisierte Jobportal
        ins Leben gerufen, um Arbeitgeber und qualifizierte Fachkraefte zusammenzubringen.
      </p>
      <div className="autorenbox-links">
        <a href="https://energietechnik-stellenangebote.de/autor/thomas-sander">Mehr ueber den Autor</a>
      </div>
    </div>
  );
};
